...
def redeem_gift_card():
    ...
    # ***** CORREÇÃO DA VULNERABILIDADE DE CONDIÇÃO DE CORRIDA AQUI *****
    ...
    # A verificação agora é segura, pois a linha está bloqueada
    if card.is_used:
    ...
    try:
        ...
        # Marca o vale-presente como usado
        card.is_used = True
        ...
        # Em caso de erro, desfaz a transação e libera o bloqueio
        db.session.rollback()
